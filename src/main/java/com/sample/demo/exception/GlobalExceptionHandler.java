...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIResponse> handleValidationExceptions(ConstraintViolationException ex) {
        return ResponseEntity.badRequest().body(new APIResponse(Constant.INVALID_INPUT));
    }
}
